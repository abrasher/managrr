...
export type UserFieldsFragment = { __typename?: 'PlexUser' } & Pick<PlexUser, 'id' | 'title'> & {
    sharedServers: Array<
      { __typename?: 'PlexSharedServer' } & Pick<
        PlexSharedServer,
        'id' | 'machineIdentifier' | 'allLibraries'
      > & { libraries: Array<{ __typename?: 'PlexSharedLibrary' } & Pick<PlexSharedLibrary, 'id'>> }
    >
  }
...
export type RemovePlexInstanceMutation = { __typename?: 'Mutation' } & {
  removePlexInstance?: Maybe<{ __typename?: 'PlexInstance' } & PlexFieldsFragment>
}
...
export type UpsertPlexInstanceMutation = { __typename?: 'Mutation' } & {
  upsertPlexInstance: { __typename?: 'PlexInstance' } & PlexFieldsFragment
}

export type PlexFieldsFragment = { __typename?: 'PlexInstance' } & Pick<
  PlexInstance,
...
export type PreviewPosterMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'previewPoster'>

export type UpsertRadarrInstanceMutationVariables = Exact<{
  input: UpsertRadarrInstanceInput
}>

export type UpsertRadarrInstanceMutation = { __typename?: 'Mutation' } & {
  upsertRadarrInstance: { __typename?: 'RadarrInstance' } & RadarrFieldsFragment
}
...
export type RemoveRadarrInstanceMutation = { __typename?: 'Mutation' } & {
  removeRadarrInstance?: Maybe<{ __typename?: 'RadarrInstance' } & RadarrFieldsFragment>
}

export type RadarrFieldsFragment = { __typename?: 'RadarrInstance' } & Pick<
  RadarrInstance,
  'id' | 'instanceName' | 'url' | 'apiKey'
>
...
export type RunTaskMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'runTask'>

export type UpdatePosterSettingsMutationVariables = Exact<{
  input: PosterGenerationInput
}>

export type UpdatePosterSettingsMutation = { __typename?: 'Mutation' } & {
  updatePosterSettings: { __typename?: 'PosterGenerationSettings' } & PosterFieldsFragment
}
...
export type UpdateSettingsMutation = { __typename?: 'Mutation' } & {
  updateSettings: { __typename?: 'Settings' } & Pick<
    Settings,
    'id' | 'language' | 'port' | 'plexAccountToken'
  >
}
...
export type UpdateUsersMutation = { __typename?: 'Mutation' } & {
  updateUsers: Array<{ __typename?: 'PlexUser' } & UserFieldsFragment>
}

export type GetMediaQueryVariables = Exact<{ [key: string]: never }>

export type GetMediaQuery = { __typename?: 'Query' } & {
  media: Array<
...
export type GetSettingsQuery = { __typename?: 'Query' } & {
  settings: { __typename?: 'Settings' } & Pick<
    Settings,
    'id' | 'language' | 'plexAccountToken' | 'port' | 'omdbKey'
  > & { posterSettings: { __typename?: 'PosterGenerationSettings' } & PosterFieldsFragment }
  plexInstances: Array<{ __typename?: 'PlexInstance' } & PlexFieldsFragment>
  radarrInstances: Array<{ __typename?: 'RadarrInstance' } & RadarrFieldsFragment>
}

export type PosterFieldsFragment = { __typename?: 'PosterGenerationSettings' } & Pick<
  PosterGenerationSettings,
  | 'BLEND_MODE'
  | 'DESTINATION_OPACITY'
  | 'FONT_COLOUR'
  | 'GLOBAL_ICON_SCALE'
...
export type GetSystemQuery = { __typename?: 'Query' } & {
  system: { __typename?: 'System' } & Pick<System, 'version'> & {
      tasks: Array<
        { __typename?: 'Task' } & Pick<Task, 'name' | 'started' | 'completed' | 'status'>
      >
    }
}
...
export type GetUsersQuery = { __typename?: 'Query' } & {
  account: { __typename?: 'PlexAccount' } & {
    servers: Array<
      { __typename?: 'PlexDeviceServer' } & Pick<
        PlexDeviceServer,
        'id' | 'clientIdentifier' | 'name'
      > & {
          libraries: Array<
            { __typename?: 'PlexSharedLibrary' } & Pick<PlexSharedLibrary, 'id' | 'title' | 'type'>
          >
        }
    >
    users: Array<{ __typename?: 'PlexUser' } & UserFieldsFragment>
  }
}
...
export const PosterFieldsFragmentDoc: DocumentNode<PosterFieldsFragment, unknown> = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'posterFields' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'PosterGenerationSettings' },
      },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'BLEND_MODE' } },
          { kind: 'Field', name: { kind: 'Name', value: 'DESTINATION_OPACITY' } },
          { kind: 'Field', name: { kind: 'Name', value: 'FONT_COLOUR' } },
          { kind: 'Field', name: { kind: 'Name', value: 'GLOBAL_ICON_SCALE' } },
          { kind: 'Field', name: { kind: 'Name', value: 'JPEG_QUALITY' } },
          { kind: 'Field', name: { kind: 'Name', value: 'RATING_SCALE' } },
          { kind: 'Field', name: { kind: 'Name', value: 'SOURCE_OPACITY' } },
          { kind: 'Field', name: { kind: 'Name', value: 'SPACING' } },
          { kind: 'Field', name: { kind: 'Name', value: 'BOX_COLOUR' } },
        ],
      },
    },
  ],
...
export const PreviewPosterDocument: DocumentNode<
  PreviewPosterMutation,
  PreviewPosterMutationVariables
> = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'previewPoster' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'PosterGenerationInput' } },
          },
        },
      ],
      selectionSet: {
...
export const RunTaskDocument: DocumentNode<RunTaskMutation, RunTaskMutationVariables> = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'RunTaskInput' } },
          },
        },
      ],
      selectionSet: {
...
export const UpdatePosterSettingsDocument: DocumentNode<
  UpdatePosterSettingsMutation,
  UpdatePosterSettingsMutationVariables
> = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'updatePosterSettings' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'FragmentSpread', name: { kind: 'Name', value: 'posterFields' } },
              ],
            },
          },
        ],
    ...
    ...PosterFieldsFragmentDoc.definitions,
  ],
}
...
export const UpdateUsersDocument: DocumentNode<UpdateUsersMutation, UpdateUsersMutationVariables> =
  {
    kind: 'Document',
    definitions: [
      {
...
export const GetMediaDocument: DocumentNode<GetMediaQuery, GetMediaQueryVariables> = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'plexMetadata' } },
                { kind: 'Field', name: { kind: 'Name', value: 'radarrMetadata' } },
                { kind: 'Field', name: { kind: 'Name', value: 'omdbMetadata' } },
                { kind: 'Field', name: { kind: 'Name', value: 'tmdbMetadata' } },
              ],
            },
          },
        ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'plexAccountToken' } },
                { kind: 'Field', name: { kind: 'Name', value: 'port' } },
                { kind: 'Field', name: { kind: 'Name', value: 'omdbKey' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'posterSettings' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'FragmentSpread', name: { kind: 'Name', value: 'posterFields' } },
...
export const GetSystemDocument: DocumentNode<GetSystemQuery, GetSystemQueryVariables> = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getSystem' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
export type AbsPlexDeviceKeySpecifier = (
  | 'name'
  | 'publicAddress'
  | 'product'
  | 'productVersion'
...
export type PlexAccountKeySpecifier = (
  | 'id'
  | 'username'
  | 'uuid'
  | 'email'
...
export type PlexDeviceKeySpecifier = (
  | 'name'
  | 'publicAddress'
  | 'product'
  | 'productVersion'
...
export type PlexDeviceServerKeySpecifier = (
  | 'name'
  | 'publicAddress'
  | 'product'
  | 'productVersion'
...
export type PlexInstanceKeySpecifier = (
  | 'id'
  | 'machineIdentifier'
  | 'friendlyName'
  | 'url'
  | 'token'
  | PlexInstanceKeySpecifier
)[]
...
export type PlexSharedLibraryKeySpecifier = (
  | 'id'
  | 'key'
  | 'title'
  | 'type'
  | PlexSharedLibraryKeySpecifier
)[]
...
export type PlexSharedServerKeySpecifier = (
  | 'id'
  | 'name'
  | 'ownerId'
  | 'invitedId'
...
export type PlexUserKeySpecifier = (
  | 'id'
  | 'title'
  | 'username'
...
export type PosterGenerationSettingsKeySpecifier = (
  | 'SOURCE_OPACITY'
  | 'DESTINATION_OPACITY'
  | 'BLEND_MODE'
  | 'SPACING'
  ...
  | 'JPEG_QUALITY'
  | 'BOX_COLOUR'
  | PosterGenerationSettingsKeySpecifier
)[]
...
export type RadarrInstanceKeySpecifier = (
  | 'id'
  | 'url'
  | 'apiKey'
  | 'instanceName'
  | RadarrInstanceKeySpecifier
)[]
...
export type RadarrQualityProfileKeySpecifier = (
  | 'id'
  | 'name'
  | 'upgradeAllowed'
  | 'language'
  | RadarrQualityProfileKeySpecifier
)[]
...
export type TypedTypePolicies = TypePolicies & {
  ...
  PlexDeviceConnection?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PlexDeviceConnectionKeySpecifier
      | (() => undefined | PlexDeviceConnectionKeySpecifier)
  ...
  PlexDeviceServer?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PlexDeviceServerKeySpecifier
      | (() => undefined | PlexDeviceServerKeySpecifier)
  ...
  PlexSharedLibrary?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PlexSharedLibraryKeySpecifier
      | (() => undefined | PlexSharedLibraryKeySpecifier)
  ...
  PlexSharedServer?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PlexSharedServerKeySpecifier
      | (() => undefined | PlexSharedServerKeySpecifier)
  ...
  PosterGenerationSettings?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PosterGenerationSettingsKeySpecifier
      | (() => undefined | PosterGenerationSettingsKeySpecifier)
  ...
  RadarrQualityProfile?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | RadarrQualityProfileKeySpecifier
      | (() => undefined | RadarrQualityProfileKeySpecifier)
