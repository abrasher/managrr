...
import type { PosterGenerationInput } from '@/frontend/graphql/generated-types'
import {
  BlendMode,
  GetSettingsDocument,
  PreviewPosterDocument,
  UpdatePosterSettingsDocument,
} from '@/frontend/graphql/generated-types'
import { useMutation, useQuery } from '@/frontend/hooks/graphql'
